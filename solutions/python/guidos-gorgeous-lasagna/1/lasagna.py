...
def preparation_time_in_minutes(number_of_layers):
    ...
    :param number_of_layers: takes the number of layers used to prepare the delicious lasagna
    :return: preparation time in minutes
    This function takes the number of layers of the lasagna and calculate the overall preparation time in minutes
    """
