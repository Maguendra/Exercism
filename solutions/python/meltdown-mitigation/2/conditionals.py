...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    overall_activity = temperature * neutrons_produced_per_second
    low_threshold = 0.9 * threshold
    high_threshold = 1.1 * threshold

    if overall_activity < low_threshold:
        return 'LOW'
    elif overall_activity <= high_threshold and overall_activity >= low_threshold:
        return 'NORMAL'
    else:
        return 'DANGER'
